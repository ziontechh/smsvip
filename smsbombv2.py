...
░░░░░░░░░░░░░░▀▄▄▄▄▄░░░░░█
    ...
    Mesaj: {}           {}KODLAYAN {}@Emir Kanlıoğlu\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS BASMA (DANDİK)\n\n 2- SMS Gönder (ÖNERİYORUM)\n\n 3- Çıkmak için\n\n" + Fore.LIGHTYELLOW_EX + " Hangisi ? "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Düzgün gir aq şunu")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasını başında +90 olmadan yaz bakam (Birden çoksa enter tuşuna bas): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            print(Fore.LIGHTYELLOW_EX + "Telefon numaralarının kayıtlı olduğu dosyanın klasörü yaz: "+ Fore.LIGHTGREEN_EX, end="")
            dizin = input()
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "YANLIŞ SEÇTİN AQ. Tekrar dene.")
                sleep(3)
                continue
        else:
            try:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + f"Kaç adet SMS göndereyim {sonsuz}: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Kaç saniyede bir göndereyim: "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Çıkış yapıyorum.")
        break
    elif menu == 2:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasını başında +90 olmadan yaz bakam: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "DÜZGÜN GİR AQ. TEKRAR DENE.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
